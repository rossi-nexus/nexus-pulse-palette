...
LANGUAGE: All output (entry names, evidence, descriptions) MUST be in English. If a source page is in another language (e.g. Norwegian, Swedish, Danish, Finnish), translate to clear professional English. Proper nouns (company, product brand, person, place names) stay as-is.
